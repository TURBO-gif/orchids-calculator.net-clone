...
export default function AutoLoanCalculatorPage() {
  ...
  const [downPaymentPercent, setDownPaymentPercent] = useState('16.67');
  ...
  const calculate = () => {
    ...
    if (rate === 0) {
      ...
      setResult({
        ...
        tradeInValue: tradeIn.toFixed(2)
      });
      generateAmortizationSchedule(loanAmount, 0, n, monthly);
      return;
    }
  ...
  return (
    <CalculatorLayout title="Auto Loan Calculator" description="Calculate your monthly car payment with down payment and trade-in value. View detailed amortization schedule.">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Input Section */}
        <div className="space-y-4">
          <div className="bg-card p-4 rounded-[3px] border border-border">
            <h3 className="font-bold text-base mb-4">Auto Loan Details</h3>
                  ...
                  <div className="flex items-center gap-2 flex-1">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        updateDownPaymentPercent(autoPrice, e.target.value);
                      }}
                      className="flex-1 border border-input rounded-[3px] px-3 py-2 text-sm"
                    />
                  </div>
                  <div className="flex items-center gap-2 flex-1">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        updateDownPayment(autoPrice, e.target.value);
                      }}
                      className="flex-1 border border-input rounded-[3px] px-3 py-2 text-sm"
                    />
                    <span className="text-sm">%</span>
        ...
        <div className="space-y-4">
          {result ? (
              ...
              <div className="bg-card p-4 rounded-[3px] border border-border">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between py-1">
                    ...
                    <span className="font-semibold">{formatCurrency(autoPrice)}</span>
                  </div>
                  <div className="flex justify-between py-1">
                    <span className="text-muted-foreground">Down Payment:</span>
                    <span className="font-semibold">{formatCurrency(result.downPayment)}</span>
                  </div>
                  {parseFloat(result.tradeInValue) > 0 && (
                    <div className="flex justify-between py-1">
            ...
            <div className="bg-muted p-8 rounded-[3px] text-center text-muted-foreground">
              <p>Enter auto loan details and click Calculate to see your results</p>
            </div>
          )}
        </div>
      </div>
